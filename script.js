...
const translations = {
  it: {
    nav_home:"Home", nav_services:"Servizi", nav_method:"Metodo", nav_experience:"Esperienza", nav_writing:"Scrittura", nav_project:"Progetto", nav_blog:"Blog", nav_contact:"Contatti",
    hero_role:"Traduttrice · Proofreader · Editor · Fact-checker",
    hero_langs:"Dall’inglese e dal francese all’italiano",
    hero_title:"Traduzione, revisione e verifica dei testi.",
    hero_lead:"Un lavoro sul linguaggio, sulla struttura e sui contenuti, con attenzione alla voce dell’autore, al contesto e alla precisione.",
    discover:"Scopri i servizi", contact_me:"Contattami",
    hero_note_1:"Lingua", hero_note_2:"Voce", hero_note_3:"Struttura", hero_note_4:"Contesto", hero_note_5:"Precisione",
    ...
    method_kicker:"IL MIO METODO", method_title:"Precisione, contesto, visione d’insieme.",
    ...
    experience_kicker:"ESPERIENZA", experience_title:"Esperienza editoriale e linguistica costruita nel tempo.",
    ...
    contact_kicker:"CONTATTI", contact_title:"Parliamo del tuo prossimo testo.", email_label:"Email", email_work_label:"Email professionale",
    footer_role:"TRADUTTRICE · PROOFREADER · EDITOR · FACT-CHECKER"
  },
  en: {
    nav_home:"Home", nav_services:"Services", nav_method:"Method", nav_experience:"Experience", nav_writing:"Writing", nav_project:"Project", nav_blog:"Blog", nav_contact:"Contact",
    hero_role:"Translator · Proofreader · Editor · Fact-checker",
    hero_langs:"English and French into Italian",
    hero_title:"Translation, revision and fact-checking.",
    hero_lead:"Work on language, structure and content, with close attention to the author’s voice, context and accuracy.",
    discover:"Explore services", contact_me:"Contact me",
    hero_note_1:"Language", hero_note_2:"Voice", hero_note_3:"Structure", hero_note_4:"Context", hero_note_5:"Precision",
    ...
    method_kicker:"MY METHOD", method_title:"Precision, context, the whole picture.",
    ...
    experience_kicker:"EXPERIENCE", experience_title:"Editorial and language experience built over time.",
    ...
    contact_kicker:"CONTACT", contact_title:"Let’s talk about your next text.", email_label:"Email", email_work_label:"Professional email",
    footer_role:"TRANSLATOR · PROOFREADER · EDITOR · FACT-CHECKER"
  },
  fr: {
    nav_home:"Accueil", nav_services:"Services", nav_method:"Méthode", nav_experience:"Expérience", nav_writing:"Écriture", nav_project:"Projet", nav_blog:"Blog", nav_contact:"Contact",
    hero_role:"Traductrice · Correctrice · Révision éditoriale · Fact-checking",
    hero_langs:"De l’anglais et du français vers l’italien",
    hero_title:"Traduction, révision et vérification des textes.",
    hero_lead:"Un travail sur la langue, la structure et les contenus, avec une attention particulière à la voix de l’auteur, au contexte et à la précision.",
    discover:"Découvrir les services", contact_me:"Me contacter",
    hero_note_1:"Langue", hero_note_2:"Voix", hero_note_3:"Structure", hero_note_4:"Contexte", hero_note_5:"Précision",
    ...
    method_kicker:"MA MÉTHODE", method_title:"Précision, contexte, vision d’ensemble.",
    ...
    experience_kicker:"EXPÉRIENCE", experience_title:"Une expérience éditoriale et linguistique construite au fil du temps.",
